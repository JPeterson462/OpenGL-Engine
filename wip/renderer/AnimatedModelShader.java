...
public class AnimatedModelShader extends ShaderProgram {
	...
	private static final InputStream VERTEX_SHADER = AnimatedModelShader.class.getClassLoader().getResourceAsStream("renderer/animatedEntityVertex.glsl");
	private static final InputStream FRAGMENT_SHADER = AnimatedModelShader.class.getClassLoader().getResourceAsStream("renderer/animatedEntityFragment.glsl");
